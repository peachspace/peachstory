...
class StorymainWidget extends StatefulWidget {
  const StorymainWidget({
    super.key,
    this.storymainRef,
    this.storychatRef,
    this.isNovelMode,
  ...
  static String routeName = 'storymain';
  static String routePath = '/storymain';

  @override
  State<StorymainWidget> createState() => _StorymainWidgetState();
}

class _StorymainWidgetState extends State<StorymainWidget> {
  late StorymainModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StorymainModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<StoriesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final storymainStoriesRecord = snapshot.data!;
                                      ...
                                      return Dialog(
                                        ...
                                        child: WebViewAware(
                                          child: GestureDetector(
                                            ...
                                            child: ModeselectWidget(
                                              storydoc: storymainStoriesRecord,
                                            ),
                                          ),
                                        ),
                                      );
