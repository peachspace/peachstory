...
class StorycreateWidget extends StatefulWidget {
  ...
  @override
  State<StorycreateWidget> createState() => _StorycreateWidgetState();
}

class _StorycreateWidgetState extends State<StorycreateWidget>
    with TickerProviderStateMixin {
  late StorycreateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StorycreateModel());
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: TextFormField(
                                              ...
                                              focusNode:
                                                  _model.worldSettingsFocusNode,
                                              onChanged: (_) =>
                                                  EasyDebounce.debounce(
                                                '_model.worldSettingsTextController',
                                                Duration(milliseconds: 2000),
                                                () async {
                                                  _model.worldview = _model
                                                      .worldSettingsTextController
                                                      .text;
                                                  safeSetState(() {});
                                                },
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: TextFormField(
                                                ...
                                                focusNode:
                                                    _model.prologueFocusNode,
                                                onChanged: (_) =>
                                                    EasyDebounce.debounce(
                                                  '_model.prologueTextController',
                                                  Duration(milliseconds: 2000),
                                                  () async {
                                                    _model.prologue = _model
                                                        .prologueTextController
                                                        .text;
                                                    safeSetState(() {});
                                                  },
                                                ...
                                                cursorColor:
                                                    FlutterFlowTheme.of(context)
                                                        .primaryText,
                                                validator: _model
                                                    .prologueTextControllerValidator
                                                    .asValidator(context),
                                              ),
                                            ),
                                          ),
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  5.0),
                                                      child: Text(
                                                        '이야기 속에 등장할 주요 캐릭터들을 입력해 주세요.       캐릭터는 8개까지 추가할 수 있어요.',
                                                        textAlign:
                                                            TextAlign.center,
                                                        style:
                                                            FlutterFlowTheme.of(
                                                ...
                                                if (selectedMedia != null &&
                                                    selectedMedia.every((m) =>
                                                        validateFileFormat(
                                                            ...
                                                            context))) {
                                                  safeSetState(() => _model
                                                          .isDataUploading_uploadedMainImage =
                                                      true);
                                                  ...
                                                  try {
                                                    ...
                                                    _model.isDataUploading_uploadedMainImage =
                                                        false;
                                                  }
                                                  if (selectedUploadedFiles
                                                      ...
                                                      downloadUrls.length ==
                                                          selectedMedia
                                                              .length) {
                                                    safeSetState(() {
                                                      _model.uploadedLocalFile_uploadedMainImage =
                                                          selectedUploadedFiles
                                                              .first;
