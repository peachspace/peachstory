...
import 'storyusername_model.dart';
export 'storyusername_model.dart';
...
class _StoryusernameWidgetState extends State<StoryusernameWidget> {
  late StoryusernameModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StoryusernameModel());
