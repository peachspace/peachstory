...
import 'storycomment_model.dart';
export 'storycomment_model.dart';

class StorycommentWidget extends StatefulWidget {
  ...
  @override
  State<StorycommentWidget> createState() => _StorycommentWidgetState();
}

class _StorycommentWidgetState extends State<StorycommentWidget> {
  late StorycommentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StorycommentModel());
