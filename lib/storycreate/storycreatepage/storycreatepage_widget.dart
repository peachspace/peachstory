...
class _StorycreatepageWidgetState extends State<StorycreatepageWidget>
  ...
  void initState() {
    ...
    _model.outlineSwitchValue = _model.outlineSwitch;
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                                  ...
                                                  queryParameters: {
                                                    ...
                                                    'initialCharacter':
                                                      ...
                                                      CharacterStructStruct(
                                                        ...
                                                        seed: 0,
                                                        profileimage: '\' \'',
                                                        emotionStruct: functions
                                                            .getEmptyEmotionList(),
                                                        basePrompt: '\' \'',
                                                        abilityStruct: functions
                                                            .getEmptyabilityList(),
                                                        appearance: '\' \'',
                                                        ability: '\' \'',
                                                      ),
                                        ...
                                        if (FFAppState().Characters.length > 0)
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 20.0, 0.0, 0.0),
                                                ...
                                                Align(
                                                  alignment:
                                                      AlignmentDirectional(
                                                          -1.0, 0.0),
                                                  child: Text(
                                                    '아웃라인을 입력하면 입력한 전개에 따라 스토리를 진행합니다.',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                                            ...
                                                            child:
                                                              ...
                                                              cursorColor:
                                                                  FlutterFlowTheme.of(
                                                                      ...
                                                                      .primaryText,
                                                              validator: _model
                                                                  .outlineTextControllerValidator
                                                                  .asValidator(
                                                                      context),
                                                            ),
                                                          ),
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            ...
                                                            _model.generatingTarget =
                                                                'outline';
                                                            safeSetState(() {});
                                                            _model.generatedoutline =
                                                                await actions
                                                                    .generateEventField(
                                                              '[제목]: ${_model.storyNameTextController.text}\\n[세계관]: ${_model.worldSettingsTextController.text}\\n[주요 장소]: ${_model.placetextfieldTextController.text}\\n[캐릭터들]: ${functions.convertCharactersToString(FFAppState().Characters.toList())}\\n[유저 역할]: ${_model.userRoleInfoTextController.text}\\n[주요 사건]: ${_model.outlineTextController.text}',
                                                              FFAppState()
                                                                  .draftId,
                                                              _model
                                                                  .outlineTextController
