...
class _CharactercomponentWidgetState extends State<CharactercomponentWidget> {
  ...
  void initState() {
    ...
    _model.charSkillTextController ??=
        TextEditingController(text: widget.characterData?.personality);
    _model.charSkillFocusNode ??= FocusNode();
                                  ...
                                  onTap: () async {
                                    ...
                                    if (widget.isWorldviewEmpty == true) {
                                      ...
                                      FFAppState().updateCharactersAtIndex(
                                        widget.index!,
                                        (e) =>
                                            e..personality = _model.personality,
                                      );
                                      safeSetState(() {});
                                      FFAppState().isGenerating = false;
                                      FFAppState().generatingTarget = '';
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.charAppearanceTextController,
                                      focusNode: _model.charAppearanceFocusNode,
                                      autofocus: false,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        isDense: true,
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    FFAppState().updateCharactersAtIndex(
                                      widget.index!,
                                      (e) => e..appearance = _model.appearance,
                                    );
                                    safeSetState(() {});
                                    FFAppState().isGenerating = false;
                                    FFAppState().generatingTarget = '';
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.charSkillTextController,
                                      focusNode: _model.charSkillFocusNode,
                                      autofocus: false,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        isDense: true,
                                      ...
                                      cursorColor: FlutterFlowTheme.of(context)
                                          .primaryText,
                                      validator: _model
                                          .charSkillTextControllerValidator
                                          .asValidator(context),
                                    ),
                                  ),
                                ),
