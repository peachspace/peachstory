...
class _ImagecreatebottomsheetWidgetState
  ...
  void initState() {
    ...
    _model.eventpromptTextController ??= TextEditingController();
    _model.eventpromptFocusNode ??= FocusNode();
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      focusNode:
                                          _model.backgroundpromptFocusNode,
                                      autofocus: false,
                                      enabled: true,
                                      obscureText: false,
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      focusNode:
                                          _model.situationpromptFocusNode,
                                      autofocus: false,
                                      enabled: true,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            controller: _model
                                                .eventpromptTextController,
                                            focusNode:
                                                _model.eventpromptFocusNode,
                                            autofocus: false,
                                            enabled: true,
                                            obscureText: false,
                                            decoration: InputDecoration(
                                            ...
                                            enableInteractiveSelection: true,
                                            validator: _model
                                                .eventpromptTextControllerValidator
                                                .asValidator(context),
                                          ),
                                        ),
                                      ),
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          _model.isGenerating = true;
                                          _model.generatingTarget = 'event';
                                          safeSetState(() {});
                                          _model.eventtagPrompt = await actions
                                              .generateTriggerKeyword(
                                            'event',
                                            widget.receivedevent!,
                                          );
                                          safeSetState(() {
                                            _model.eventpromptTextController
                                                ?.text = _model.eventtagPrompt!;
                                          });
                                          _model.isGenerating = false;
                                          _model.generatingTarget = null;
                                          safeSetState(() {});
