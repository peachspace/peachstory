...
class _CharsettingpageWidgetState extends State<CharsettingpageWidget> {
  ...
  void initState() {
    ...
    _model.charAppearanceTextController ??=
        TextEditingController(text: _model.editchar?.appearance);
                                      ...
                                      onTap: () async {
                                        ...
                                        if (selectedMedia != null &&
                                          ...
                                          try {
                                            ...
                                            _model.isDataUploading_uploadprofile =
                                                false;
                                          }
                                          if (selectedUploadedFiles.length ==
                                              ...
                                              downloadUrls.length ==
                                                  selectedMedia.length) {
                                            safeSetState(() {
                                              _model.uploadedLocalFile_uploadprofile =
                                                  selectedUploadedFiles.first;
                                              _model.uploadedFileUrl_uploadprofile =
                                                  downloadUrls.first;
                                            });
                                          } else {
                                            safeSetState(() {});
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Stack(
                                children: [
                                  if ((FFAppState().isGenerating == true) &&
                                      (FFAppState().generatingTarget ==
                                          'char_\${index}_name'))
                                    Container(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              ...
                                              FFAppState().generatingTarget =
                                                  'char_\${index}_setting';
                                              safeSetState(() {});
                                              _model.personality = await actions
                                                  .generateCharacterField(
                                                'char_set',
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              ...
                                              FFAppState().generatingTarget =
                                                  'char_\${index}_appearance';
                                              safeSetState(() {});
                                              _model.appearance = await actions
                                                  .generateCharacterField(
                                                'appearance',
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              ...
                                              FFAppState().generatingTarget =
                                                  'char_\${index}_intro';
                                              safeSetState(() {});
                                              _model.introduce = await actions
                                                  .generateCharacterField(
                                                'char_intro',
                                ...
                                children: [
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      context.pushNamed(
                                        EmotionimagelistWidget.routeName,
                                        queryParameters: {
                                  ...
                                  children: [
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        context.pushNamed(
                                          AbilityimagelistWidget.routeName,
                                          queryParameters: {
                                            'abilityTags': serializeParam(
