...
import 'storychatsettingcomponent_model.dart';
export 'storychatsettingcomponent_model.dart';

class StorychatsettingcomponentWidget extends StatefulWidget {
  const StorychatsettingcomponentWidget({
    super.key,
  ...
  @override
  State<StorychatsettingcomponentWidget> createState() =>
      _StorychatsettingcomponentWidgetState();
}

class _StorychatsettingcomponentWidgetState
    extends State<StorychatsettingcomponentWidget>
    with TickerProviderStateMixin {
  late StorychatsettingcomponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StorychatsettingcomponentModel());
