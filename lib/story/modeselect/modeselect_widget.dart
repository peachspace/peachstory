...
import '/story/storyusername/storyusername_widget.dart';
import '/index.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:webviewx_plus/webviewx_plus.dart';
import 'modeselect_model.dart';
export 'modeselect_model.dart';
...
class ModeselectWidget extends StatefulWidget {
  ...
  @override
  State<ModeselectWidget> createState() => _ModeselectWidgetState();
}

class _ModeselectWidgetState extends State<ModeselectWidget> {
  late ModeselectModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModeselectModel());
