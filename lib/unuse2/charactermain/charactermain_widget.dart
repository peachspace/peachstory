...
class CharactermainWidget extends StatefulWidget {
  ...
  static String routeName = 'charactermain';
  static String routePath = '/charactermain';

  @override
  State<CharactermainWidget> createState() => _CharactermainWidgetState();
}

class _CharactermainWidgetState extends State<CharactermainWidget> {
  late CharactermainModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CharactermainModel());
                      ...
                      children: [
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                valueOrDefault<String>(
                                  _model.loadedCharacter?.mainimage,
                                  '\" \"',
                                ),
                                width: 360.0,
                                height: 360.0,
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              valueOrDefault<String>(
                                _model.loadedCharacter?.introduce,
                                '안녕하세요?',
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                            ...
                            child: Builder(
                              builder: (context) {
                                ...
                                return Wrap(
                                  ...
                                  children: List.generate(hashtagItem.length,
                                      (hashtagItemIndex) {
                                    final hashtagItemItem =
                                        hashtagItem[hashtagItemIndex];
                                    return Text(
                                      '# ${hashtagItemIndex.toString()}',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            font: GoogleFonts.inter(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  FutureBuilder<int>(
                                    future: queryCharacterCommentsRecordCount(
                                      queryBuilder: (characterCommentsRecord) =>
                                          characterCommentsRecord.where(
                                        'character_ref',
                                        isEqualTo:
                                            _model.loadedCharacter?.reference,
                                      ),
                                    ),
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 20.0, 0.0, 0.0),
                          child: FutureBuilder<List<CharacterCommentsRecord>>(
                            future: queryCharacterCommentsRecordOnce(
                              queryBuilder: (characterCommentsRecord) =>
                            ...
                            builder: (context, snapshot) {
                              ...
                              return ListView.builder(
                                ...
                                itemCount:
                                    listViewCharacterCommentsRecordList.length,
