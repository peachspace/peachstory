...
class CharactercommentWidget extends StatefulWidget {
  const CharactercommentWidget({
    super.key,
  ...
  @override
  State<CharactercommentWidget> createState() => _CharactercommentWidgetState();
}

class _CharactercommentWidgetState extends State<CharactercommentWidget> {
  late CharactercommentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CharactercommentModel());
