...
class DeleteCommentAndRepliesCloudFunctionCallResponse {
...
class IndexStoryCloudFunctionCallResponse {
  IndexStoryCloudFunctionCallResponse({
    this.errorCode,
    this.succeeded,
    this.jsonBody,
  });
...
class GenerateReplicateImageCloudFunctionCallResponse {
  GenerateReplicateImageCloudFunctionCallResponse({
    this.errorCode,
    this.succeeded,
    this.jsonBody,
    this.resultAsString,
...
class CallAiSummaryCloudFunctionCallResponse {
  CallAiSummaryCloudFunctionCallResponse({
    this.errorCode,
    this.succeeded,
    this.jsonBody,
    this.resultAsString,
