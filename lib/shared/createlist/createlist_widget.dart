...
import 'createlist_model.dart';
export 'createlist_model.dart';

class CreatelistWidget extends StatefulWidget {
  const CreatelistWidget({super.key});

  static String routeName = 'createlist';
  static String routePath = '/createlist';
...
class _CreatelistWidgetState extends State<CreatelistWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (FFAppState().cachedMyCreations.length == 0) {
        _model.creations = await actions.loadMyCreations();
        FFAppState().cachedMyCreations =
            _model.creations!.toList().cast<CombinedListItemStructStruct>();
        safeSetState(() {});
      }
    });
              ...
              child: Column(
                ...
                children: [
                    ...
                    builder: (context) {
                      if (valueOrDefault<bool>(
                        ...
                        return InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed(CreatorrequestWidget.routeName);
                          },
                          child: Container(
                            width: 100.0,
                            height: 100.0,
                  ...
                  Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        final item = FFAppState().cachedMyCreations.toList();
                            ...
                            return Container(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    if (functions.isCharacterType(itemItem)) {
                                      context.pushNamed(
                                            ...
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                ...
                                                if (confirmDialogResponse) {
                                                  ...
                                                  _model.refreshedList =
                                                      await actions
                                                          .loadMyCreations();
                                                  _model.combinedList = _model
                                                      .refreshedList!
                                                      .toList()
                                                      .cast<
