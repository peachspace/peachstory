            ...
            children: [
              AuthUserStreamWidget(
                builder: (context) => Builder(
                  builder: (context) {
                    final heartlist =
                        (currentUserDocument?.heartedstory.toList() ?? [])
                            .toList();
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, heartlistIndex) {
                        final heartlistItem = heartlist[heartlistIndex];
                        return StreamBuilder<StoriesRecord>(
                          stream: StoriesRecord.getDocument(heartlistItem),
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          image: DecorationImage(
                                            fit: BoxFit.cover,
                                            image: Image.network(
                                              containerStoriesRecord.mainImage,
                                            ).image,
                                          ),
                                          borderRadius:
