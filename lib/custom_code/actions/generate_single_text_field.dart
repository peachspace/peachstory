...
[팔수 설정] (아래 항목들은 반드시 포함하세요.)
외모: (머리색, 눈동자, 옷차림 등 묘사)
성격: (성격 키워드 및 행동 양식)
말투: (말투 설명, 반드시 대화 예시 3개 포함)
 - 대화 예시 1: "흥, 네가 그걸 해낼 수 있을까?"
 - 대화 예시 2: (캐릭터 성격에 맞는 대사)
 - 대화 예시 3: (캐릭터 성격에 맞는 대사)

[임의 설정] (아래 항목 중 필요한 항목이 있다면 포함하세요)
가치관:
비밀:
트라우마:
좋아하는 것:
...
""";
    ...
    // [캐릭터 소개]: 요약된 정보
    specificInstruction = """
- 독자들이 캐릭터 창에서 한눈에 파악할 수 있도록, 위 설정을 바탕으로 요약하여 소개하세요.
- 캐릭터의 핵심 정체성과 역할을 명확하게 드러내세요.
- **[절대 금지]** '성격:', '외모:' 같은 분류 라벨이나 개조식 나열을 하지 마세요.
""";
